...
const GameOver = () => {
  ...
  return (
    <div className='h-[90vh] flex flex-col   items-center justify-between py-[8%] sm:py-[3%]' style={{backgroundImage:`url(${score == 0 ? LOST : WIN})`,backgroundPosition:"center",backgroundSize:"cover"}}>
